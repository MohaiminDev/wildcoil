...
const PROFILES := {
	...
	"tar_spitter": {
		"id": "tar_spitter",
		"display_name": "Tar Spitter",
		"archetype": "ranged",
		"health": 50,
		"walk_speed": 68.0,
		"engage_range": 420.0,
		"preferred_range": 270.0,
		"attack_range": 420.0,
		"attack_windup": 0.50,
		"damage": 10,
		"knockback_x": 150.0,
