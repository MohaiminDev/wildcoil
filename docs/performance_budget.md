...
- Latest local exported-app result on 2026-05-10: `avg_ms=1.476`, `max_ms=1.515`, `budget_ms=33.3`, `max_budget_ms=120.0`, `window_size=1280x720`, `window_mode=windowed`, with 8 warmup frames excluded.
