...
- Latest local exported-app result on 2026-05-12: `avg_ms=10.126`, `max_ms=22.409`, `budget_ms=33.3`, `max_budget_ms=120.0`, `window_size=1280x720`, `window_mode=windowed`, with 8 warmup frames excluded.
