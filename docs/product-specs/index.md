...
- Current demo path: title screen, hero select, Stage 1, enemy waves, Brask Noll boss, Stage Clear/victory screen, restart or return-to-title, and macOS package, as described in `to-do.md`.
