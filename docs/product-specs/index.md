...
- Current demo path: title screen, hero select, Stage 1, enemy waves, Brask Noll boss story beats, Stage Clear score/rank summary, restart or return-to-title, and macOS package, as described in `to-do.md`.
