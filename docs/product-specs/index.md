...
- Current automated focus-loss coverage: `stage1_focus_resume` in `src/wildcoil/tools/runtime_test_runner.gd` checks Stage 1 auto-pause on focus loss, visible pause overlay, return-focus copy, and Esc resume.
