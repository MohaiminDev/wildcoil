...
- Focus/audio evidence collector: `bash scripts/collect_focus_audio_evidence.sh --help` is available for real exported-app focus/audio sessions; it writes manual evidence notes and paste-ready snippets but does not substitute for actual audible output confirmation.
