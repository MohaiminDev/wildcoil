...
- Release-candidate gate: `bash scripts/check_release_candidate.sh` reports `RIFT_ROAD_RELEASE_GATE blocked` while package and player-evidence gates remain unresolved, and now includes exported-app keyboard fallback and focus/resume smoke as automated gates.
