...
- Hero-select demo scope: Raya and Nika are the playable Stage 1 demo heroes. Kian and Tor remain visible as planned roster preview cards, but confirming them stays in preview instead of starting Stage 1, so the local demo cannot accidentally launch unfinished hero slots.
